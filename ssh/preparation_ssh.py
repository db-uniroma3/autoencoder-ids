...
def main():
    train_row_json = "train_ssh_row.json"
    train_ai_json= "train_ssh_ai.json"
    test_row_json = "test_ssh_row.json"
    test_ai_json = "test_ssh_ai.json"

    train_row_csv = "train_ssh_row.csv"
    test_row_csv = "test_ssh_row.csv"
    ...
    label_detected_attacks(darktrace_ai_analyst, train_row_csv, train_row_csv) #etichetta gli attacchi rilevati da Darktrace AI Analyst

    darktrace_ai_analyst=read_json_file(test_ai_json) #carica il file json
    label_detected_attacks(darktrace_ai_analyst, test_row_csv, test_row_csv) #etichetta gli attacchi rilevati da Darktrace AI Analyst
